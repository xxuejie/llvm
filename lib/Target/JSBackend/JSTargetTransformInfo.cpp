...
unsigned JSTTIImpl::getArithmeticInstrCost(
  ...
  unsigned Cost = BasicTTIImplBase<JSTTIImpl>::getArithmeticInstrCost(Opcode, Ty, Opd1Info, Opd2Info, Opd1PropInfo, Opd2PropInfo, Args);
...
int JSTTIImpl::getCastInstrCost(unsigned Opcode, Type *Dst, Type *Src,
                                const Instruction *I) {
